...
![生成迁移文件](image/p3_2.png)

执行生成迁移文件命令后，会在应用booktest目录下的migrations目录中生成迁移文件。

生成迁移文件后的目录结构： ![生成迁移文件后](image/p3_13.png)

打开上图中的迁移文件，内容如下： ![迁移文件](image/p3_14.png)
...
sqliteman界面如下： ![sqliteman界面](image/p3_15.png)

按照下图的步骤找到要打开的数据库文件。

![打开数据库](image/p3_16.png)
...
![生成迁移文件](image/p3_19.png)

项目目录结构：

![项目目录结构](image/p3_20.png)
